...
AFirstPersonPawn::AFirstPersonPawn()
{
	...
	static ConstructorHelpers::FObjectFinder<UUPawnAttributeAsset> AssetFinder(TEXT("/Script/DynamicSpawn.UPawnAttributeAsset'/Game/FIrstPersonAsset.FIrstPersonAsset'"));
