...
ATP_ThirdPersonCharacter::ATP_ThirdPersonCharacter()
{
	...
	static ConstructorHelpers::FObjectFinder<UUPawnAttributeAsset> AssetFinder(TEXT("/Script/DynamicSpawn.UPawnAttributeAsset'/Game/ThirdPersonAsset.ThirdPersonAsset'"));
